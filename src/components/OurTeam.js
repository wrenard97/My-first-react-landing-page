...
function OurTeam() {
  return (
        ...
        <div className='bg-gray-200 pt-24 pb-28 px-12 text-center font-poppins text-gray-600 text-sm sm:px-44' id='our-team'>
            <div>
                <p className='font-crimson-text text-lg'>PROFESSIONAL</p>
                <p className='font-crimson-text text-4xl text-yellow-500 pb-12'>OUR TEAM</p>
            </div>
