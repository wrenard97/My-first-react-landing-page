...
function Testimonials() {
  return (
    <div
      className="pl-12 py-16 pr-6 text-gray-300 bg-black font-poppins bg-50 bg-left-top sm:bg-55 sm:bg-right sm:px-44 sm:bg-no-repeat"
      style={{ backgroundImage: `url(${bgtest})` }}
      id="testimonials"
    >
      <div className="">
        <p className="font-crimson-text text-base">1000+ HAPPY CLIENTS</p>
        <p className="font-crimson-text text-2xl text-yellow-500 sm:pb-8">
          TESTIMONIALS
        </p>
